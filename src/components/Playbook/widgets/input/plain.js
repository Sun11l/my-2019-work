...
export default Backbone.View.extend({
  ...
  initialize: function (t) {
    ...
    this.linked = t.linked ? t.linked : !1
    this.enableTooltip = t.tooltip ? t.tooltip : !1
    this.action = t.action ? t.action : ''
    this.data = t.data ? t.data : []
    this.filtered = t.filtered ? t.filtered : []
    this.selector = this.data.length > 0 ? !0 : !1
    this.enableTooltip = t.tooltip ? t.tooltip : !1
    this.maxlength = t.maxlength ? t.maxlength : ''
    this.filter = t.filter ? t.filter : ''
    this.enabled = !0
    this.timer = null
    this.replaceFilter = t.replaceFilter || []
