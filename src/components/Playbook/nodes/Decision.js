...
`,
  ...
  initialize: function () {
    ...
    this.on('change:status', function (t, e) {
      ...
      e === 'warn' || e === 'error' ? (t.attr('g.error/opacity', 1),
      t.attr({
        'g.error image': {
  ...
  updateParamNames: function (t, e) {
    ...
    _.each(this.outputs.models, function (i, n) {
      _.each(i.conditions.models, function (i, n) {
        ...
        var param = i.get('param')
        _.each(t, function (t) {
          if (s.match(t)) {
            value = value.replace(t, '$1' + e + '$3')
            i.set('value', value)
            return false
          } else {
            return void 0
  ...
  removeOutput: function (t, e, i) {
    ...
    t.get('type') === 'else' && this.set('hasElse', false)
    _.each(n, function (t) {
      var i = t.get('source')
  ...
  validateConfig: function (t, e, i, n) {
    ...
    this.get('has_custom_block') || _.each(this.outputs.models, function (t, o) {
      _.each(t.conditions.models, function (a, r) {
        ...
        that.field_warnings.push(c)), l === '' && c === '' && t.get('type') !== 'else' && that.warnings.push('No parameters configured on condition ' + (o + 1))
      })
    })
  },
