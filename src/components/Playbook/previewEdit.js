...
<div class="content open">
  ...
  <div id="<%= framesId %>" class="cmc-frames" style="display:none">
    <div id="<%= editorId %>" class="cmc-editor"></div>
    <div id="<%= debuggerId %>" class="cmc-debugger"></div>
  </div>
  <div id="<%= settingsId %>" class="cmc-settings" style="display:none"></div>
</div>
...
export default class PlayBook {
  ...
  initBBHack () {
    ...
    window.$.ajaxSetup({
      ...
      beforeSend: function (req, i) {
        req.setRequestHeader('Authorization', 'JWT ' + getCookie('token'))
      },
    })
